...
const AboutUs = () => {
  return (
    <div className='mt-[70px]'>
      <div className='flex flex-wrap justify-start gap-[29px] px-[60px]'>
        <div className='w-[calc(55%-14.5px)] md:w-[calc(55%-14.5px)] md:h-[336px] h-[282px] py-[18px] mb-[70px] bg-cover bg-center' style={{ backgroundImage: `url(/hands.png)` }}>

        </div>
        <div className='w-[calc(45%-14.5px)] md:w-[calc(45%-14.5px)] md:h-auto h-[282px] py-[18px] mb-[70px]'>
          <div className=''>
      ...
      <div className='flex flex-wrap justify-start gap-[29px] px-[60px]'>
        <div className='w-[calc(55%-14.5px)] md:w-[calc(55%-14.5px)] md:h-[336px] h-[282px] py-[18px] mb-[70px] bg-cover bg-center' style={{ backgroundImage: `url(/dgps.png)` }}>
        </div>
        <div className='w-[calc(45%-14.5px)] md:w-[calc(45%-14.5px)] md:h-auto h-[282px] py-[18px] mb-[70px]'>
          <div className='flex items-center h-full'>
            <p className='text-base'>We supply survey equipments like total station, dgps, levelling instrument. We also deal in engineering items like engineering models, engineering charts, laboratory microscopes, electronic balances, glassware item and many other kinds of scientific & engineering machinery along with accessories, necessary spare parts etc. Our entire product range is appreciated & used by many Construction Companies, Builders, Developers, Architects, Land Surveyors, Engineering Colleges, Educational Institutes & Universities, Research Laboratories, Civil Engineers, Professors, Scientists etc.</p>
          </div>
        </div>
      </div>


      <div className='flex flex-wrap justify-start gap-[74px] px-[170px]'>
        <div className='w-[calc(50%-37px)] md:w-[calc(50%-37px)] md:h-[336px] h-[258.7px] py-[18px] mb-[70px] bg-cover bg-center' style={{ backgroundImage: `url(/what_new.png)` }}>
        </div>

        <div className='w-[calc(50%-37px)] md:w-[calc(50%-37px)] md:h-auto h-[282px] py-[18px] mb-[70px]'>
      ...
      <div className='flex flex-wrap justify-start gap-[29px] px-[60px] py-[70px]'>
        <div className='w-[calc(55%-14.5px)] md:w-[calc(55%-14.5px)] md:h-[336px] h-[282px] py-[18px] mb-[70px] bg-cover bg-center' style={{ backgroundImage: `url(/team.png)` }}>
      ...
      <div className='flex flex-wrap justify-start gap-[74px] px-[170px] py-[100px] bg-[#F8F8F8]'>
        <div className='w-[calc(50%-37px)] md:w-[calc(50%-37px)] md:h-[336px] h-[258.7px] py-[18px] mb-[70px] bg-no-repeat bg-cover bg-center' style={{ backgroundImage: `url(/get_in_touch.png)` }}>
        </div>
