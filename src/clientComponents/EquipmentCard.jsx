...
const EquipmentCard = ({ equipment, page, subName, subId }) => {
    ...
    return (
        <div onClick={handleNavigate} className='w-full shadow-md cursor-pointer rounded-[12px]'>
            <div className='h-[160px] sm:h-[283px] rounded-t-[12px] bg-cover bg-center' style={{ backgroundImage: `url(${backgroundImage})` }}>
            </div>
            <div className='sm:h-[68.53px] px-2 sm:px-4 md:px-[31px] py-[10px] sm:py-[20px] flex gap-[13.2px] justify-center items-center overflow-hidden transition-all duration-300 rounded-b-[12px] hover:bg-gradient-to-r from-[#F8710C] to-[#F22B06] hover:text-white'>
