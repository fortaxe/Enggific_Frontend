...
const ChooseUs = () => {
    ...
    const data = [
        {
            icon: [(<img className='md:w-[38px] md:h-[38px] w-[20px] h-[20px]' src='/Award--Streamline-Tabler-Filled.svg' />)],
        ...
        {
            icon: [(<img className='md:w-[38px] md:h-[38px] w-[20px] h-[20px]' src='/Bag-Suitcase-4--Streamline-Plump-Remix.svg' />)],
        ...
        {
            icon: [(<img className='md:w-[38px] md:h-[38px] w-[20px] h-[20px]' src='/Group-Fill--Streamline-Mingcute-Fill.svg' />)],
            title: 'Expert Team',
        ...
        {
            icon: [(<img className='md:w-[38px] md:h-[38px] w-[20px] h-[20px]' src='/Call-Center-Support-Service--Streamline-Core.svg' />)],
        ...
        {
            icon: [(<img className='md:w-[38px] md:h-[38px] w-[20px] h-[20px]' src='/Alarm-Clock--Streamline-Core.svg' />)],
        ...
        {
            icon: [(<img className='md:w-[38px] md:h-[38px] w-[20px] h-[20px]' src='/Document-Currency-Rupee--Streamline-Heroicons.svg' />)],
                    ...
                    {data.map((item, index) => (
                        ...
                        >
                            <div className="flex flex-col">
                                <div className="top-0 left-[5%] bg-gradient-to-r from-[#F8710C] to-[#F22B06] w-[32px] h-[38px] md:w-[60px] md:h-[72px] flex items-center justify-center mb-[25px]">
                                    {item.icon}
                                </div>
                                <p className="text-[19.9px] lg:text-[22px] leading-[17.61px] md:leading-normal text-textBlack font-bold break-words mb-[7px] md:mb-[12px]">
                                    {item.title}
                                </p>
