    ...
    const data = [
        {
            ...
            // </svg>)],
            icon:[(<img src='/Award--Streamline-Tabler-Filled.svg' />)],
        ...
        {
            icon:[(<img src='/Bag-Suitcase-4--Streamline-Plump-Remix.svg' />)],
        ...
        {
            icon:[(<img src='/Group-Fill--Streamline-Mingcute-Fill.svg' />)],
            title: 'Expert Team',
        ...
        {
            icon:[(<img src='/Call-Center-Support-Service--Streamline-Core.svg' />)],
        ...
        {
            icon:[(<img src='/Alarm-Clock--Streamline-Core.svg' />)],
        ...
        {
            icon:[(<img src='/Document-Currency-Rupee--Streamline-Heroicons.svg' />)],
    ...
    return (
        <div className='bg-[#22384D] md:px-[60px] px-[16px] md:pb-[100px] pb-[30px] xl:pt-[70px] pt-[30px]'>
            ...
            <div className=''>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 md:gap-[29px] gap-[16px]  md:mt-[50px] mt-[16px]'>
                    {data.map((item, index) => (
                       <div
                       key={index}
                       className="w-full shadow-2xl p-4 bg-gray-800 rounded-xl group transition-all duration-300 hover:bg-gray-700"
                   >
                       <div className="flex gap-[14px] items-center mb-[18px]">
                           <div className="text-white transition-transform duration-1000 group-hover:rotate-[360deg] bg-[orange] w-[39.67px] h-[39.67px] md:w-[57px] md:h-[57px] rounded-full flex items-center justify-center">
                               {item.icon}
                           </div>
