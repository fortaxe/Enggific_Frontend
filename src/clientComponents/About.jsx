...
const About = () => {
    return (
        <div className='relative h-[436px] bg-cover bg-center' style={{ backgroundImage: `url(/about_bg.png)` }}>
            <div className="absolute inset-0 bg-white bg-opacity-95 flex flex-row justify-center items-center">
                <div className='flex flex-col justify-center items-center mb-[69.81px] mt-[70px]'>
