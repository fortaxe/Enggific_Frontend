        ...
        <div className="w-full lg:flex hidden justify-evenly items-center p-4 h-[34px]">
          ...
          <div className="lg:flex items-center hidden">
            ...
            >
              ...
              <p className="text-xs text-textBlack hover:text-orange-500 transition-all duration-300">
          ...
          <div className="lg:flex items-center hidden">
            <a
              ...
              className="text-xs text-textBlack hover:text-orange-500 transition-all duration-300"
            >
