    ...
    return (
        <div className='md:px-[60px] px-[16px]  md:pt-[60px] sm:pt-[40px] pt-[30px]'>
            <div>
                ...
                <div className="flex flex-wrap md:justify-center justify-between gap-[16px] sm:gap-[29px] ">
                    {(data.products && data.products.length > 0) && data.products.slice(0, 4).map((item, index) => (
                        <div
                            key={index}
                            className="w-[calc(50%-8px)] lg:w-[calc(25%-21.75px)] h-auto border border-[#D2D2D2] p-[14px] overflow-hidden rounded-[12px]"
                        >
