        ...
        <div className='bg-[#F8F8F8] flex justify-center items-center py-[91px]'>
            <div className='flex flex-wrap gap-[29px] max-w-[937px] w-full'>
                ...
                <div className='relative w-full sm:w-[calc(50%-14.5px)] md:w-[calc(50%-14.5px)] h-[320px] py-[61px] pl-[50px] pr-[18px] shadow-md z-[1]'>
                    <div className='z-[1]'>
                        ...
                        <div className='mb-[15px]'>
                            <p className='xl:text-[38px] text-[32px] font-bold'>Our Vision</p>
                        </div>
                        <div className=''>
                    ...
                    <div className='absolute bottom-0 left-0 -z-[1]'>
                        <svg className='w-full h-[350px] xl:w-[450px] xl:h-[450px]' viewBox="0 0 450 198" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='relative w-full sm:w-[calc(50%-14.5px)] md:w-[calc(50%-14.5px)] h-[320px] py-[61px] pl-[50px] pr-[18px] shadow-md z-[1]'>
                    ...
                    <div className='absolute bottom-0 left-0 -z-[1]'>
                        <svg className='w-full h-[300px] xl:w-[450px] xl:h-[450px]' viewBox="0 0 450 196" fill="none" xmlns="http://www.w3.org/2000/svg">
